...
<a href="{{ $property['permalink'] }}"  class="feature-grid{{ $property['featured'] ?? false ? ' property-grid__featured' : '' }}">
    ...
    @if ($property['department'] !== 'Commercial')
        ...
        <li>
            <svg enable-background="new 0 0 22 16" viewBox="0 0 22 16" xmlns="http://www.w3.org/2000/svg" class="icon__bed">
                <path d="M21.1,7.3c-0.1,0-0.2-0.1-0.2-0.2V0.4c0-0.2-0.2-0.4-0.4-0.4c0,0,0,0,0,0H1.5C1.3,0,1.1,0.2,1.1,0.4v6.7c0,0.1-0.1,0.2-0.2,0.2H0.4C0.2,7.3,0,7.4,0,7.6v5.8c0,0.2,0.2,0.4,0.4,0.4h0.5c0.1,0,0.2,0.1,0.2,0.2v1.6c0,0.2,0.2,0.4,0.4,0.4c0.2,0,0.4-0.2,0.4-0.4V14c0-0.1,0.1-0.2,0.2-0.2h18c0.1,0,0.2,0.1,0.2,0.2v1.6c0,0.2,0.2,0.4,0.4,0.4c0.2,0,0.4-0.2,0.4-0.4V14c0-0.1,0.1-0.2,0.2-0.2h0.5c0.2,0,0.4-0.2,0.4-0.4V7.6c0-0.2-0.2-0.4-0.4-0.4L21.1,7.3z M1.8,0.9c0-0.1,0.1-0.2,0.2-0.2h18c0.1,0,0.2,0.1,0.2,0.2v6.2c0,0.1-0.1,0.2-0.2,0.2h-0.4c-0.1,0-0.2-0.1-0.2-0.2V4c0-0.2-0.2-0.4-0.4-0.4h-7.3c-0.2,0-0.4,0.2-0.4,0.4v3.1c0,0.1-0.1,0.2-0.2,0.2h-0.4c-0.1,0-0.2-0.1-0.2-0.2V4c0-0.2-0.2-0.4-0.4-0.4H2.9C2.7,3.6,2.6,3.8,2.6,4v3.1c0,0.1-0.1,0.2-0.2,0.2H2c-0.1,0-0.2-0.1-0.2-0.2L1.8,0.9z M18.5,4.4c0.1,0,0.2,0.1,0.2,0.2v2.5c0,0.1-0.1,0.2-0.2,0.2h-6.2c-0.1,0-0.2-0.1-0.2-0.2V4.5c0-0.1,0.1-0.2,0.2-0.2H18.5z M9.7,4.4c0.1,0,0.2,0.1,0.2,0.2v2.5c0,0.1-0.1,0.2-0.2,0.2H3.5c-0.1,0-0.2-0.1-0.2-0.2V4.5c0-0.1,0.1-0.2,0.2-0.2H9.7z M21.3,12.9c0,0.1-0.1,0.2-0.2,0.2H0.9c-0.1,0-0.2-0.1-0.2-0.2v-1.1c0-0.1,0.1-0.2,0.2-0.2h20.2c0.1,0,0.2,0.1,0.2,0.2V12.9z M21.3,10.7c0,0.1-0.1,0.2-0.2,0.2H0.9c-0.1,0-0.2-0.1-0.2-0.2V8.2C0.7,8.1,0.8,8,0.9,8h20.2c0.1,0,0.2,0.1,0.2,0.2V10.7z"></path></svg>
            {{ $property['bedrooms'] }} 
        </li>
        @endif
